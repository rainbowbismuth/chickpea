...
typedef struct CallInfo {
	...
	union {
		struct { /* only for Lua functions */
			...
			int nextraargs; /* # of extra arguments in vararg
					   functions */
		} l;
	...
	union {
		...
		struct { /* info about transferred values (for call/return
			    hooks) */
			unsigned short ftransfer; /* offset of first value
						     transferred */
			unsigned short ntransfer; /* number of values
						     transferred */
		} transferinfo;
	} u2;
